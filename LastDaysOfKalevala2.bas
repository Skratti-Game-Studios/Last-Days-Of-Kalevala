...
IF area = 1 THEN
    ...
    anna_walk_anim(0) = 0
    anna_walk_anim_t(0) = 2
    anna_walk_anim(1) = 1
    anna_walk_anim_t(1) = 2
    anna_walk_anim(2) = 2
    anna_walk_anim_t(2) = 2
    anna_walk_anim(3) = 3
    anna_walk_anim_t(3) = 2
    anna_walk_anim(4) = 4
    anna_walk_anim_t(4) = 3
    anna_walk_anim(5) = 5
    anna_walk_anim_t(5) = 3
    anna_walk_anim(6) = 6
    anna_walk_anim_t(6) = 3
    anna_walk_anim(7) = 7
    anna_walk_anim_t(7) = 3
    ...
    anna_prejump_anim_t(0) = 1
    anna_prejump_anim(1) = 8
    anna_prejump_anim_t(1) = 1
    anna_prejump_anim(2) = 8
    anna_prejump_anim_t(2) = 1
...
DO
    ...
    _PUTIMAGE
    _SOURCE map&
    testpixel~& = POINT(anna_x + 15, anna_y + 62)
    _SOURCE gameimage&
    ...
    _PRINTSTRING (100, 55), "Empty: " + STR$(emptypixel~&), gamewin&
    _PRINTSTRING (100, 70), "100x100: " + STR$(testpixel~&), gamewin&
    ...
    ELSEIF anna_state = 3 THEN 'prejump
        'prejump
        IF anna_current% >= anna_prejump_frames THEN anna_current% = 0
    ...
    IF _KEYDOWN(CVI(CHR$(0) + "H")) THEN anna_state = 3 '_KEYDOWN(18432)
